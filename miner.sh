...
keywords=("api_key" "API_KEY" "APIKEY" "ApiKey" "admin" "UUID" "uuid" "username" "email" "ADMIN" "DB" "db" "DataBase" "database" "Mysql" "mysql" "MySql" "MYSQL" "SQL" "sql" "Sql" "apikey" "secret" "password" "token" "auth" "access" "key" "client_secret")
